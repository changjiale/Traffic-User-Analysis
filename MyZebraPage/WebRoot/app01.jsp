	...
	<script type="text/javascript">
		window.onload = function(){
	        ...
	        myChart.on("click", function(param){
	        	window.location.href="${pageContext.request.contextPath}/servlet/APP02Servlet?app01name="+param.name+"&date=${param.date}&type=${param.type}";
	        });
        }
	...
	<div class="box">
		...
		<div class="middle">
			...
			<ul class="list_two clear">
				...
				<li><a href="${pageContext.request.contextPath }/app05.jsp">小区上网能力</a>
				</li>
				<li><a href="#">小区上网喜好</a>
				</li>
			</ul>
			<div style="margin-left:14px;">
				...
				<div class="box_middle">
					<form method="post" action="${pageContext.request.contextPath }/servlet/APP01Servlet">
